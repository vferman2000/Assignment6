...
    }
    
    billing_addressType.addEventListener("change", checkbillingAddressType, false)
...
                select.appendChild(opt);
            })
        } else if (document.getElementById("york").checked) {
            document.getElementById("options").options.length = 0;
...
           }
		...
		var xgetAddress = document.getElementById("billing_addressType").value;
          var xgetBoxInfo = document.getElementById("billing_otherAddress").value;
          if ((xgetAddress === "Other" )&&(xgetBoxInfo === ""))
           {
            window.alert("Please enter Address Type");
            return false;
           }
...
           
           
       } else if (cardnumber = /(?:4[0-9]{12}(?:[0-9]{3})?)$/){
           document.getElementById('cardAlert').innerHTML = "VISA";
       } else if (cardnumber = /(?:5[1-5][0-9]{14})$/){
           document.getElementById('cardAlert').innerHTML = "MASTERCARD";
       } else if (cardnumber = /(?:3[47][0-9]{13})$/){
            document.getElementById('cardAlert').innerHTML = "AMEX";
            
            return false;
        }
            
